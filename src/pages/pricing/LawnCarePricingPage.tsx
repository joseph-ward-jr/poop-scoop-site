        ...
        <div className="container-max">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-sage-700 leading-relaxed mb-8">
              ...
              Professional lawn care services launching soon.
            </p>
        ...
        <div className="container-max">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-sage-700 leading-relaxed">
              Just like our pet waste removal services, our lawn care pricing will be transparent, 
...
export default LawnCarePricingPage
