...
describe('HomePage Partnerships Section', () => {
  ...
  test('partner logos have proper styling classes', () => {
    ...
    expect(petSupemarketLogo).toHaveClass('max-h-16', 'max-w-44', 'w-auto', 'mx-auto', 'opacity-70')
    expect(mountainViewLogo).toHaveClass('max-h-16', 'max-w-44', 'w-auto', 'mx-auto', 'opacity-90')
  })
})
